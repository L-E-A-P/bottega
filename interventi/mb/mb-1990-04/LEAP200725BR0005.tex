...
\codiceverticale{LEAP190725BR0005}
...
Numero di Inventario & \ocr{MB-1990-04} \\
...
\begin{flushright}
  \href{https://www.leaphz.net/aleph/index.php/s/faFawBd89t5efRR}{
    \qrcode[height=7cm]{https://www.leaphz.net/aleph/index.php/s/faFawBd89t5efRR}}
\end{flushright}
